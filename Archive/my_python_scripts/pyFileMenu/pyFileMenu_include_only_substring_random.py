...
# Get the list of Python files in the current directory that contain 'random' in their filenames
files = [file for file in os.listdir('.') if file.endswith('.py') and 'random' in file and file != os.path.basename(__file__)]
