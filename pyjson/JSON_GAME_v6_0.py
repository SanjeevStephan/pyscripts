...
jsonfile = "saved_game_template.json"
title = "Game"
subtitle = "Template"
...
show_today_info = "Today is {}. Lets Play a New Game".format(getCurrentDate())
...
def saveTheGameInJSON(correct_answers,total_questions):
    ...
    with open(jsonfile, "w") as f:
        json.dump(score, f)
    print("Game Progess saved in '{}'".format(jsonfile))
...
if __name__ == "__main__":
    os.system("cls")
    showCoolText(title)
    showCoolText(subtitle)
    loadTheGameScore()
    print(show_today_info)
    randomMultiplication()